...
func (r *InMemoryAssetRepo) Create(ctx context.Context, asset *domain.Asset) error {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *InMemoryAssetRepo) GetByID(ctx context.Context, id string) (*domain.Asset, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func (r *InMemoryAssetRepo) BatchCreate(ctx context.Context, assets []*domain.Asset) error {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *InMemoryAssetRepo) GetStats(ctx context.Context) (*domain.StatsResponse, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func (r *InMemoryAssetRepo) List(ctx context.Context, page, limit int, assetType, status string) ([]*domain.Asset, int, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func (r *InMemoryAssetRepo) Search(ctx context.Context, query string, maxResults int) ([]*domain.Asset, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func matchFilter(a *domain.Asset, assetType, status string) bool {
